...
import com.alfray.timeriffic.app.t1.TimerifficApp1;
...
public class ProfilesUiTest extends ActivityInstrumentationTestCase2<ProfilesUI> {
    ...
    private TimerifficApp1 mApplication;
    ...
    private TimerifficApp startApplication(boolean showAutoIntro) {
        ...
        if (mApplication == null) {
            ...
            if (ac instanceof TimerifficApp1) {
                mApplication = (TimerifficApp1) ac;
        ...
        try {
            if (mApplication == null) {
                mApplication = (TimerifficApp1) Instrumentation.newApplication(
                                TimerifficApp1.class,
